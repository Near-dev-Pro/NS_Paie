...
Window {
    id: recapCBD
    title: qsTr("Récapitulatif annuel RLD")
    ...
    property string minsNameFr: "MINPOSTEL"
    property string minsNameEn: "MINPOSTEL"
    property string nameFr: "RADIO TELEVISION LA DISTINCTION"
    property string nameEn: "DISTINCTION RADIO TELEVISION"
    ...
    Shortcut {
        ...
        onActivated: {
            let stat = printableContainer.grabToImage(function (result) {
                MyApi.startPreviewDoc(result.image, "RECAP ANNUEL RLD");
            });
        }
    }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            model = MyApi.getHisOfDepRecapAn(5, theData.theYear)
                        }
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            model = MyApi.getHisOfDepRecapAnTot(5, theData.theYear)
                        }
