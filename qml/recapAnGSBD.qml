...
Window {
    id: recapCBD
    title: qsTr("Récapitulatif annuel GSBD")
    ...
    property string logoSrc: "qrc:/assets/images/logos/GSBD.png"
    property string minsNameFr: "MINEDUB"
    property string minsNameEn: "MINEDUB"
    property string arrondFr: "INSPECTION D’ARRONDISSEMENT NGAOUNDERE Ier"
    property string arrondEn: "NGAOUNDERE 1er SUBDIVIONAL INSPECTORAT"
    property string nameFr: "GROUPE SCOLAIRE BILINGUE LA DISTINCTION"
    property string nameEn: "LA DISTINCTION BILINGUAL NURSERY AND PRIMARY SCHOOL"
    ...
    Shortcut {
        ...
        onActivated: {
            let stat = printableContainer.grabToImage(function (result) {
                MyApi.startPreviewDoc(result.image, "RECAP ANNUEL GSBD");
            });
        }
    }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            model = MyApi.getHisOfDepRecapAn(4, theData.theYear)
                        }
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            model = MyApi.getHisOfDepRecapAnTot(4, theData.theYear)
                        }
