    ...
    Shortcut {
        ...
        onActivated: {
            let stat = printableContainer.grabToImage(function (result) {
                MyApi.startPreviewDoc(result.image, "Bulletin-GSBD");
            });
        }
    }
    ...
    ScrollView {
        ...
        Rectangle {
            ...
            HeaderDoc{
                ...
                minsNameFr: "MINEDUB"
                minsNameEn: "MINEDUB"
                arrondFr: "INSPECTION D’ARRONDISSEMENT NGAOUNDERE Ier"
                arrondEn: "NGAOUNDERE 1er SUBDIVIONAL INSPECTORAT"
                nameFr: "GROUPE SCOLAIRE BILINGUE LA DISTINCTION"
                nameEn: "LA DISTINCTION BILINGUAL NURSERY AND PRIMARY SCHOOL"
                headerData: {
