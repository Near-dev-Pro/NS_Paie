...
Window {
    id: recapCBD
    title: qsTr("Récapitulatif annuel CPBI")
    ...
    property string logoSrc: "qrc:/assets/images/logos/CPBI.png"
    property string minsNameFr: "MINISTERE DES ENSEIGNEMENTS SECONDAIRES"
    property string minsNameEn: "MINISTRY OF SECONDARY EDUCATION"
    property string imatFr: "N° d’Immatriculation: 2JJ2GSBD100191109"
    property string imatEn: "Immatricultion number : 2JJ2GSBD100191109"
    property string nameFr: "COLLEGE POLYVALENT BILINGUE IYA"
    property string nameEn: "IYA’S COMPREHENSIVE BILINGUAL HIGH SCHOOL"
    ...
    Shortcut {
        ...
        onActivated: {
            let stat = printableContainer.grabToImage(function (result) {
                MyApi.startPreviewDoc(result.image, "RECAP ANNUEL CPBI");
            });
        }
    }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            model = MyApi.getHisOfDepRecapAn(2, theData.theYear)
                        }
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            model = MyApi.getHisOfDepRecapAnTot(2, theData.theYear)
                        }
