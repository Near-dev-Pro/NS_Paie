...
Window {
    id: recapCBD
    title: qsTr("Récapitulatif annuel CBD")
    ...
    property string logoSrc: "qrc:/assets/images/logos/CBD.png"
    ...
    property string imatFr: "N° d’Immatriculation: 2JJ2GSBD113287119"
    property string imatEn: "Immatricultion number: 2JJ2GSBD113287119"
    property string nameFr: "COLLEGE BILINGUE LA DISTINCTION"
    property string nameEn: "LA DISTINCTION BILINGUAL COLLEGE"
    ...
    Shortcut {
        ...
        onActivated: {
            let stat = printableContainer.grabToImage(function (result) {
                MyApi.startPreviewDoc(result.image, "RECAP ANNUEL CBD");
            });
        }
    }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            model = MyApi.getHisOfDepRecapAn(1, theData.theYear)
                        }
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            model = MyApi.getHisOfDepRecapAnTot(1, theData.theYear)
                        }
