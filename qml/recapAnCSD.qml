...
Window {
    id: recapCBD
    title: qsTr("Récapitulatif annuel CSD")
    ...
    Shortcut {
        ...
        onActivated: {
            let stat = printableContainer.grabToImage(function (result) {
                MyApi.startPreviewDoc(result.image, "RECAP ANNUEL CSD");
            });
        }
    }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            model = MyApi.getHisOfDepRecapAn(3, theData.theYear)
                        }
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            model = MyApi.getHisOfDepRecapAnTot(3, theData.theYear)
                        }
