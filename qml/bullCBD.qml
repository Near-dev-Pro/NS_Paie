...
Window {
    ...
    Shortcut {
        ...
        onActivated: {
            let stat = printableContainer.grabToImage(function (result) {
                MyApi.startPreviewDoc(result.image, "Bulletin-CBD");
            });
        }
    }
    ...
    ScrollView {
        ...
        Rectangle {
            ...
            HeaderDoc{
                id: headerDoc
                logoSrc: "qrc:/assets/images/logos/CBD.png"
                minsNameFr: "MINISTERE DES ENSEIGNEMENTS SECONDAIRES"
                minsNameEn: "MINISTRY OF SECONDARY EDUCATION"
                imatFr: "N° d’Immatriculation: 2JJ2GSBD113287119"
                imatEn: "Immatricultion number: 2JJ2GSBD113287119"
                nameFr: "COLLEGE BILINGUE LA DISTINCTION"
                nameEn: "LA DISTINCTION BILINGUAL COLLEGE"
                headerData: {
