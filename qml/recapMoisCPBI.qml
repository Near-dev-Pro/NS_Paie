...
Window {
    id: recapCBD
    title: qsTr("Récapitulatif mensuel CPBI")
    ...
    Shortcut {
        ...
        onActivated: {
            let stat = printableContainer.grabToImage(function (result) {
                MyApi.startPreviewDoc(result.image, "RECAP MENSUEL CPBI");
            });
        }
    }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            model = MyApi.getHisOfDepRecapMens(2, theData.theYearMonth)
                        }
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            model = MyApi.getHisOfDepRecapMensTot(2, theData.theYearMonth)
                        }
